...
code, and you have Blender itself to build it.
...
Build after each meaningful edit rather than writing a long script blind.

## Writing the Python

- Start from an empty scene: \`bpy.ops.wm.read_factory_settings(use_empty=True)\` clears the startup
  cube, camera, and light.
- Name every object you create. A scene full of \`Cube.003\` is a scene you cannot talk about.
